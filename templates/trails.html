...
<html>
    <head>
        ...
        <script src="./src/js/jspsych.js"></script>
        <script src="./src/js/plugins/jspsych-html-keyboard-response.js"></script>
        <script src="./src/js/plugins/jspsych-image-keyboard-response.js"></script>
